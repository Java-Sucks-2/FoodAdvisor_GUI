...
public class Register3 {
  ...
  public static void main(final String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
      ...
      @Override
      public void run() {
        final Register3 form = new Register3();
  ...
  public Register3() {
    ...
    final FWindow window = new FWindow("Register 3/3");
    ...
    final FTextField emailR_tf = new FTextField(38, new Font("Manrope", Font.PLAIN, 20));
    emailR_tf.addMouseListener(new MouseAdapter() {
			@Override
    ...
    emailR_tf.addFocusListener(new FocusAdapter() {
			@Override
    ...
    emailR_tf.setBorder(new LineBorder(Color.BLACK, 1));
    setGridCoordinatesXY(gbc, 0, 2);
    gbc.insets = new Insets(10, 0, 0, 0);
    emailR_tf.setBackground(Color.WHITE);
    loginPane.add(emailR_tf, gbc);

    final FTextField passwordR_tf = new FTextField(38, new Font("Manrope", Font.PLAIN, 20));
    passwordR_tf.addFocusListener(new FocusAdapter() {
			@Override
        ...
        passwordR_tf.setBorder(new LineBorder(Color.BLACK, 1));
    gbc.insets = new Insets(10, 0, 0, 0);
    setGridCoordinatesXY(gbc, 0, 3);
    // gbc.insets = new Insets(-60,0,50,0);
    loginPane.add(passwordR_tf, gbc);

    final FTextField rPassword_tf = new FTextField(38, new Font("Manrope", Font.PLAIN, 20));
    rPassword_tf.addFocusListener(new FocusAdapter() {
			@Override
			public void focusLost(final FocusEvent arg0) {
        //focus lost
			}
        ...
        rPassword_tf.setBorder(new LineBorder(Color.BLACK, 1));
    gbc.insets = new Insets(10, 0, 0, 0);
    setGridCoordinatesXY(gbc, 0, 4);
    // gbc.insets = new Insets(-60,0,50,0);
    loginPane.add(rPassword_tf, gbc);
    ...
    final FButton continue_btn = new FButton("Registrati");
    ...
    final FLabel procedure_lb = new FLabel("3/3", new Font("Manrope", Font.PLAIN, 15));
    setGridCoordinatesXY(gbc, 0, 1);
    gbc.insets = new Insets(10, 0, 0, 0);
    gbc.ipadx = -100;
