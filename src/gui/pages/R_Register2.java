...
public class R_Register2 {
    ...
    boolean streetnametxtAlreadyClicked;
    ...
    public R_Register2() {
        ...
        FPage address_pane = new FPage();
        setGridCoordinatesXY(gbc, 0, 4);
        gbc.insets = new Insets(30, 0, 0, 0);
        gbc.fill = GridBagConstraints.HORIZONTAL;
        page.add(address_pane, gbc);

        String[] values = new String[] {"Tipo Indirizzo","Via","Piazza"};
        FComboBox addresstype_cb = new FComboBox(values, new Font("Manrope", Font.PLAIN, 22));
        addresstype_cb.setBorder(new LineBorder(Color.BLACK, 1));
        //gbc.weightx = 0.5;
        //gbc.fill = GridBagConstraints.HORIZONTAL;
        gbc.insets = new Insets(0, 0, 0, 0);
        setGridCoordinatesXY(gbc, 0, 0);
        address_pane.add(addresstype_cb, gbc);

        FTextField addressname_tf = new FTextField(38, new Font("Manrope", Font.PLAIN, 22));
        ...
        addressname_tf.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(final FocusEvent e) {
                //focus gained
                if(!streetnametxtAlreadyClicked || addressname_tf.getText().equals("Nome della Via")) {
                    addressname_tf.setText("");
                    streetnametxtAlreadyClicked = true;
        ...
        gbc.insets = new Insets(0, 0, 0, 0);
        setGridCoordinatesXY(gbc, 0, 0);
        address_pane.add(addressname_tf, gbc);
